...
public class BrbrasilTreeDAO {

	private Connection connection;

	public BrbrasilTreeDAO(boolean indice) throws SQLException {
		...
		if (indice) {
			...
			this.connection.prepareStatement("create index indextree on ocorrenciapessoa using btree (opeid)").execute();
		} else {
			this.connection.prepareStatement("drop index indextree").execute();
		}
